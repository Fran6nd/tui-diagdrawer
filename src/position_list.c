...
/* Calculate which char should be displayed from the index of a list containing all line's points. */
...
/* Calculate which char should be displayed from the index of a list containing all arrow's points. */
